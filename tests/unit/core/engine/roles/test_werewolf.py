...
class TestWerewolfRoleActions:
    ...
    def test_werewolf_can_kill_at_night(self, werewolf) -> None:
        """存活狼人在 NIGHT_ACTION 阶段可以刀人。"""
        assert werewolf.can_act(GamePhase.NIGHT_ACTION, ActionType.WOLF_KILL) is True
    ...
    def test_werewolf_cannot_kill_in_other_night_phases(self, werewolf) -> None:
        """狼人仅在 NIGHT_ACTION 阶段可以刀人，其他夜间子阶段不行。"""
    ...
    def test_werewolf_cannot_use_other_skills(self, werewolf) -> None:
        """狼人不能执行其他角色的专属动作。"""
        assert werewolf.can_act(GamePhase.NIGHT_ACTION, ActionType.SEER_CHECK) is False
        assert werewolf.can_act(GamePhase.NIGHT_ACTION, ActionType.WITCH_SAVE) is False
        assert werewolf.can_act(GamePhase.NIGHT_ACTION, ActionType.WITCH_POISON) is False

    def test_dead_werewolf_cannot_kill(self, werewolf) -> None:
        """死亡狼人不能刀人。"""
        werewolf.die()
        assert werewolf.can_act(GamePhase.NIGHT_ACTION, ActionType.WOLF_KILL) is False
    ...
    def test_werewolf_validate_at_night(self, werewolf) -> None:
        ...
        assert werewolf.validate_action(GamePhase.NIGHT_ACTION, ActionType.WOLF_KILL) is True
